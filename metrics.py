...
def readDepthImages(renders_dir, gt_dir):
    renders = []
    gts = []
...
def evaluate(model_paths, scannetpp_root):
    ...
    for scene_dir in model_paths:
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                depth_renders_dir = method_dir / "vis"
                depth_gt_dir = (
                    scannetpp_root
                    / scene_id
                    / "iphone_undistorted"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--scannetpp_root", type=str, default="/mnt/data/scannetpp/rendered_depth"
    )
    args = parser.parse_args()
    evaluate(args.model_paths, args.scannetpp_root)
